...
import { Mail, Phone, MapPin, Clock, Send, Loader2, Instagram, Facebook, Twitter, Youtube } from "lucide-react";
...
export default function Contact() {
  ...
  const contactEmail = settings?.contact?.email || "hello@everywear.com";
  const contactPhone = settings?.contact?.phone || "+1 (555) 123-4567";
  const contactAddress = settings?.contact?.address || "123 Fashion District, New York, NY 10012";
              ...
              <div className="pt-12 border-t border-border/50 space-y-8">
                ...
                <div className="flex flex-wrap gap-8">
                  {[
                    ...
                    <a 
                      key={social.name} 
                      href={`https://${social.name.toLowerCase()}.com/everywear`} 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="text-muted-foreground hover:text-primary transition-all hover:scale-110 duration-300 min-h-[44px] flex items-center"
