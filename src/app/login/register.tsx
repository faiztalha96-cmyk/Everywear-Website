    ...
    <div className="min-h-[80vh] flex items-center justify-center p-6 bg-secondary/30">
      ...
      >
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-serif font-bold uppercase tracking-widest">Create Account</h1>
          <p className="text-xs text-muted-foreground uppercase tracking-widest font-bold">Join the Everywear heritage</p>
        </div>
        ...
        <div className="text-center">
          <p className="text-xs text-muted-foreground">
            ...
            <Link href="/login" className="text-foreground font-bold uppercase tracking-widest hover:text-primary transition-colors">
              Sign In
            </Link>
          </p>
        </div>
